...
export default class MapDrawer {
  ...
  init_stellar_body(stellar_body) {
    ...
    const line_color = Color.to_pixi(Color.darker(stellar_body.color, 30))
  ...
  update_stellar_body(graphics) {
    const stellar_body = graphics.backlink
    const coords = Util.from_polar_coords(stellar_body.orbital_angle, stellar_body.orbital_radius)
