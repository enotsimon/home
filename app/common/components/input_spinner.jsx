    ...
    return (
      <div className="input-group">
        <span className="input-group-btn">
          <a className="btn btn-danger" onClick={this.click_down.bind(this)}><span className="glyphicon glyphicon-minus" /></a>
        </span>
        ...
        <span className="input-group-btn">
          <a className="btn btn-info" onClick={this.click_up.bind(this)}><span className="glyphicon glyphicon-plus" /></a>
        </span>
      </div>
    )
  }
