const text = {
  ...
  items: {
    bottle: {
      name: "пустая бутылка",
      description: "просто пустая бутылка, в нее можно налить что угодно",
    },
    blank_scroll: {
      name: "чистый свиток заклинания",
      description: "на нем можно написать любое заклинание. если умеешь",
    },
    humble_dress: {
      name: "скромное платье",
      description: "простое серое платье из грубой ткани",
    },
    dried_fish: {
      name: "сушеная рыба",
      description: "полоски высушенного рыбьего мяса",
    },
    fearful_beasts_book: {
      name: 'книга "ужасные твари темных глубин"',
      description: "старая потрепанная книга. картинки в ней вероятно были, но все уже кем-то вырваны",
    },
  },
