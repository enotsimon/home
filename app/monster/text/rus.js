  ...
  scenes: {
    mage_room: {
      ...
      description: [
        ...
        "весь стол завален неизвестными алхимическими ингредиентами, эликсирами, порошками, разным оборудованием и всем тем что сопутствует профессии алхимика. о назначении большинства этих вещей ратни даже не догадывается. далее стоит {огромный шкаф|furniture|shelf}. что в нем лежит ратни никогда не видела. еще дальше {кровать мага|furniture|bed} в каменной выемке.",
